...
def fetch_channels(url):
    ...
    try:
        ...
        if is_m3u:
            parse_m3u(lines, channels)
        else:
            parse_txt(lines, channels)
    ...
    for line in lines:
        ...
        if "#genre#" in line:
            ...
            if match:
                ...
                channels[current_category].append((channel_name.strip(), channel_url.strip()))
            elif line:
...
if __name__ == "__main__":
    ...
    update_channel_urls(channels, template_channels)
